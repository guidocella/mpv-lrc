...
If mpv supports background transparency on your platform, you can display lyrics in a transparent overlay with `--background=color --background-color=0/0 --ontop --input-cursor-passthrough`.
